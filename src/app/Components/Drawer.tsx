...
const Drawer: React.FC<DrawerProps> = ({ isOpen, onClose, data, error, loading }) => {
  ...
  return (
    <div
      className={`fixed top-0 right-0 w-64 bg-gray-900 text-white h-full transition-transform transform ${isOpen ? 'translate-x-0' : 'translate-x-full'
        } flex flex-col`}
    >
      ...
      {loading ? <div>loading...</div> : <div className="flex-grow overflow-y-auto">
